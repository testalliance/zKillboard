...
var snowStorm = (function(window, document) {
  ...
  this.flakesMax = 0;           // Limit total amount of snow made (falling + sticking)
  this.flakesMaxActive = 1;      // Limit amount of snow falling at once (less = lower CPU use)
  ...
  */
  ...
  this.useWebFont = false;         // (if supported by browser) use embedded EOT/TTF/WOFF font file for real snowflake characters
...
// this.use3DRotate = false;
  ...
  function checkFontFace() {
    ...
    */
    ...
    return supportAtRule('@font-face { font-family: "font"; src: "http://zkillboard.com/wwflakes-webfont.ttf"; }');
    ...
    */
    ...
    text = {
      ...
      value: [
        ...
        "src: url('http://zkillboard.com/wwflakes-webfont.eot');",
        "src: local('?'), url('http://zkillboard.com/wwflakes-webfont.woff') format('woff'), url('http://zkillboard.com/wwflakes-webfont.ttf') format('truetype');",
        "font-weight: normal;",
        "font-style: normal;"
      ]
    };
