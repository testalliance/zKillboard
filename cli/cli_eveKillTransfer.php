...
class cli_eveKillTransfer implements cliCommand
{
	public function getDescription()
	{
		return "Transfers killmails from EVE-KILL to zKillboard. |w|Beware! This script ONLY works for the zKillboard guys!|n| |g|Usage: eveKillTransfer";
	}
