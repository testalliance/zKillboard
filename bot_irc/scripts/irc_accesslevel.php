...
class irc_accesslevel implements ircCommand {
	...
	public function execute($nick, $uhost, $channel, $command, $parameters, $nickAccessLevel) {
		...
		if (strlen($pName)) return "|r|You must be $pName to check access level.  Have them type: |g|.z accesslevel";
		...
		if ($accessLevel === null) return "|r|You are not registered.|n|";
		else return "|g|Your access level is:|n| $accessLevel";
	}
